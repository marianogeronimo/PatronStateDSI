...
namespace PatronState.Clases
{
    abstract class Estado
    {
        ...
        public abstract void finalizarPreparacion(DateTime fechaHoraActual, DetallePedido detalle);
        ...
        public HistorialEstado crearHistorialEstado(DateTime fechaInicio)
        {
